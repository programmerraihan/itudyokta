        ...
        <div class="bg-blur">
            <div class="container">
                <div class="row">
                    ...
                    <h3 style="text-align: center;"> If you are interested, fill this form and we will contact you.</h3>
                </div>
                ...
                <div class="callback_location">
                    <div class="row ">
                        <div class="location col-md-12 col-sm-12 col-xs-12" data-aos="fade-left" data-aos-duration="3000">
