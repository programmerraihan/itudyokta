    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form action="{{ route('branch.homework.update', ['id' => $homework->id]) }}" method="POST">
                    @csrf

                        <div class="col-lg-12">
                            <fieldset>
                                <legend> Student Home Work  </legend>
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" value="{{$homework->title}}" placeholder="Title"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="formrow-inputState" name="session_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Session --
                                                            </option>
                                                            
                                                                @foreach ($sessions as $session)
                                                                    <option value="{{ $session->id }}" {{($session->id == $homework->session_id) ? 'selected' : '' }}> {{ $session->name }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="formrow-inputState" name="course_title_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Course --
                                                            </option>
                                                            
                                                                @foreach ($courseTitles as $courseTitle)
                                                                    <option value="{{ $courseTitle->id }}" {{($courseTitle->id == $homework->course_title_id) ? 'selected' : '' }}> {{ $courseTitle->title }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                                        ...
                                                        <select id="formrow-inputState" name="branch_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Branch --
                                                                ...
                                                                @foreach ($branches as $branch)
                                                                    <option value="{{ $branch->id }}"  {{($branch->id == $homework->branch_id) ? 'selected' : '' }}> {{ $branch->name }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <select id="batch_id" name="batch_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Batch --
                                                                ...
                                                                @foreach ($batches as $batch)
                                                                    <option value="{{ $batch->id }}"  {{($batch->id == $homework->batch_id) ? 'selected' : '' }}> {{ $batch->name }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="formrow-inputState" name="schedule_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Schedule --
                                                            </option>
                                                            
                                                                @foreach ($schedules as $schedule)
                                                                    <option value="{{ $schedule->id }}" {{($schedule->id == $homework->schedule_id) ? 'selected' : '' }}> {{ $schedule->name }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                        ...
                                                        <select id="teacher_id" name="teacher_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Teacher --
                                                                ...
                                                                @foreach ($teachers as $teacher)
                                                                    <option value="{{ $teacher->id }}" {{($teacher->id == $homework->teacher_id) ? 'selected' : '' }}>> {{ $teacher->name }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="sample_copy" placeholder="Sample Copy"
                                                            class="form-control">

                                                            <img src="{{ asset('admin/image/homework/' . $homework->sample_copy) }}"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="input_file">
                                                            <label for="submission_deadline">  Submission  Start Deadline<span
                                                                    class="text-danger">*</span>
                                                            </label>
                                                        </div>
                                                        <input type="date" name="submission_deadline"   value="{{ $homework->submission_deadline }}"  placeholder="Submission Deadline"
                                                            class="form-control">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="input_file">
                                                            <label for="submission_end_deadline">  Submission  End Deadline<span
                                                                    class="text-danger">*</span>
                                                            </label>
                                                        </div>
                                                        <input type="date" name="submission_end_deadline"  value="{{ $homework->submission_end_deadline}}"  placeholder="Submission  End Deadline"
                                                            class="form-control">
