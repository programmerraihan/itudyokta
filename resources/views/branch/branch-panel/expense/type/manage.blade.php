                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('branches-expenseType.store') }}" method="POST">
                                        @csrf
                
                                        <div class="form-group row mb-4">
                                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label"> Expense Type
                                                Name</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row mb-4">
                                            <label for="horizontal-email-input1" class="col-sm-2 col-form-label">Expense Type
                                                Description</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row justify-content-end">
                                            <div class="col-sm-10">
                                                ...
                                                <div>
                                                    <button type="submit" class="btn btn-primary w-md">Create New Expense Type </button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <tbody>
                            @foreach ($expense_types as $expenseType)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('branch.expenseType.update-status', ['id' => $expenseType->id]) }}"
                                            class="btn {{ $expenseType->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                            <i class="fas fa-arrow-alt-circle-up"></i>
                                        </a>

                                    
                                        <a href="{{ route('branches-expenseType.edit', $expenseType->id) }}"
                                            class="btn btn-success btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>

                                        <a href="{{ route('branches-expenseType.destroy', $expenseType->id) }}"
                                        ...
                                        <form method="POST"
                                            action="{{ route('branches-expenseType.destroy', $expenseType->id) }}"
