                ...
                <div class="col-lg-12">
                    <fieldset>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    <form action=" {{ route('branch.expense.store') }} " method="POST">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h4 class="card-title mb-4">New Expense </h4>
                                                        <hr />
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" type="text" name="expense_description" id="horizontal-email-input195"> </textarea>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-body pb-1">
                                                    <div class="form-group ">
                                                        <button type="submit" class="btn btn-primary w-md btn-block">Create New
                                                            Expense </button>
                                                    </div>
                                                </div>
                                            </div>
