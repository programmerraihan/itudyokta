                                ...
                                @foreach ($expenses as $expense)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a href="{{ route('branch.expense.update-status', ['id' => $expense->id]) }}"
                                                class="btn {{ $expense->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                <i class="fas fa-arrow-alt-circle-up"></i>
                                            </a>
    
    
                                            <a href="{{ route('branch.expense.detail', ['id' => $expense->id]) }}"
                                                class="btn btn-primary btn-sm">
                                                <i class="fas fa-book-open"></i>
                                            </a>
                                            <a href="{{ route('branch.expense.edit', $expense->id) }}"
                                            ...
                                            <form method="POST"
                                                action="{{ route('branch.expense.destroy', ['id' => $expense->id]) }}"
