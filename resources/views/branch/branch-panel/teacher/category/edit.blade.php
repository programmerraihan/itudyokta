    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Edit Teacher Category</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Layouts</a></li>
                                <li class="breadcrumb-item active">Edit Teacher Category</li>
                            </ol>
                        </div>
                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.teacher.category.index') }}" class=" float-right btn btn-primary">Teacher Category</a>
                                </h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <fieldset>
                        <legend> Edit Teacher Category</legend>
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">

                                    <form method="POST" action="{{ route('branch.teacher.category.update', ['id' => $category->id]) }}" enctype="multipart/form-data">
                                        @csrf
