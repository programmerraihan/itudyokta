                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.add.teacher.category') }}" class=" float-right btn btn-primary">Add
                                        Teacher Category</a>
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                {{-- <a href="{{ route('branch.teacher.category.update-status', ['id' => $category->id]) }}"
                                                    class="btn {{ $category->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a> --}}


                                                <a href=" {{ route('branch.teacher.category.edit', $category->id) }}"
                                            ...
                                            <form method="POST"
                                                action="{{ route('branch.teacher.category.destroy', ['id' => $category->id]) }}"
