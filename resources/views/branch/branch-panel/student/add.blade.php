...
@section('admin')
    <div class="page-content">
        <div class="container-fluid">
                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.student.index') }}"
                                        class=" float-right btn btn-primary">Student</a>
                                </h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="POST" action="{{ route('branch.store.student') }}" enctype="multipart/form-data"
                        target="_blank">
                        @csrf
                        <div class="col-lg-12"> 
                            ...
                            <fieldset>
                                <legend>Student Confidentiality
                                </legend>
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="last_education_roll"
                                                            placeholder="Roll No:" class="form-control"
                                                            id="last_education_roll">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="last_education_reg"
                                                            placeholder="Reg. No:" class="form-control"
                                                            id="last_education_reg">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="last_education_year"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="course_start_date"
                                                            placeholder="dd/M/year" class="form-control" id="month">
                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="numer" name="reg_no_student"
                                                            placeholder="Reg. No:" class="form-control"
                                                            id="reg_no_student">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="numer" name="roll_no_student"
                                                            placeholder="Roll No:" class="form-control"
                                                            id="roll_no_student">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="input_file">
                                                            <label for="session">Fund <span class="text-danger">*</span>
                                                            </label>
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input_file">
                                                            <label for="director">Signature of Center Director<span
                                                                    class="text-danger">*</span>
                                                            </label>
                                                        </div>
                                                        <input type="file" name="director"
                                                            placeholder="Signature of Center Director"
...
@section('script')
    <script>
        ...
        //         $('#batch_id').html('');
        //         $.ajax({
        //             url: '{{ route('branch.wish.batch') }}?id='+id,
        //             type: 'get',
