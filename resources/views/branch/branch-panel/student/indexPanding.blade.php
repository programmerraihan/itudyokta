                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                <h4>
                                    <a href="{{ route('branch.add.student') }}" class=" float-right btn btn-primary">Add student</a>
                                </h4>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                           ...
                                           {{-- @dd( \App\Models\CourseTitle::find($item->course_title_id)->title)  --}}
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('branch.student.update-status', ['id' => $student->id]) }}"
                                                    class="btn {{ $student->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>
                                                <a href="{{ route('branch.student.detail', ['id' => $student->id]) }}"
                                                ...
                                                <a href=" {{ route('branch.student.edit', $student->id) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('branch.student.destroy', ['id' => $student->id]) }}"
