                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.notice.index') }}" class=" float-right btn btn-primary">Notice</a>
                                </h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('branch.notice.update', ['id' => $notice->id]) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="time">Time <span class="text-danger">*</span>
                                                    </label>
                                                    <input type="time" value="{{ $notice->time }}" name="time"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <img src="{{ asset('frontend/notice/' . $notice->image) }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="long_text" class="form-control" id="long_text">{{ $notice->long_text }}  </textarea>
