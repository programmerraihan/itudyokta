                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.add.category') }}" class=" float-right btn btn-primary">Add
                                        Category Course</a>
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('branch.category.update-status', ['id' => $category->id]) }}"
                                                    class="btn {{ $category->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>


                                                <a href=" {{ route('branch.category.edit', $category->id) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('branch.category.destroy', ['id' => $category->id]) }}"
