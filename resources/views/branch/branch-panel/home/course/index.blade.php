                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.add.course') }}" class=" float-right btn btn-primary">Add Course</a>
                                    ...
                                    @foreach ($courses as $course)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('branch.course.update-status', ['id' => $course->id]) }}"
                                                    class="btn {{ $course->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>


                                                <a href=" {{ route('branch.course.edit', $course->id) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('branch.course.destroy', ['id' => $course->id]) }}"
