            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Edit district</h4>
                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.district.index') }}" class=" float-right btn btn-primary">district</a>
                                </h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('branch.district.update', ['id' => $district->id]) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="formrow-inputState" name="division_id" class="form-control">
                                                        <option value="" disabled selected>-- Select division --
                                                        </option>

                                                      
                                                        @foreach ($divisions as $division)
                                                            <option value="{{ $division->id }}" {{($division->id == $district->division_id) ? 'selected' : '' }}> {{ $division->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$district->name}}" name="name" class="form-control"
                                                        id="name">
