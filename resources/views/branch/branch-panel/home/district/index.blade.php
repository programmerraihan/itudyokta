            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">District</h4>
                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.add.district') }}" class=" float-right btn btn-primary">Add
                                        District</a>
                                    ...
                                    @foreach ($districts as $district)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('branch.district.update-status', ['id' => $district->id]) }}"
                                                    class="btn {{ $district->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>


                                                <a href=" {{ route('branch.district.edit', $district->id) }}"
                                                ...
                                                onclick="event.preventDefault(); document.getElementById('districtForm{{ $district->id }}').submit();">
                                                <i class="fas fa-trash-alt"></i>
                                            </a>

                                            <form method="POST"
                                                action="{{ route('branch.district.destroy', ['id' => $district->id]) }}"
                                                id="districtForm{{ $district->id }}">
                                                @csrf
                                            </form>
