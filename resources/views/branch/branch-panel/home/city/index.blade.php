                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.add.city') }}" class=" float-right btn btn-primary">Add
                                        City</a>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title"> City info Goers Here</h4>
                            {{-- <h4>
                                    ...
                                    @foreach ($citys as $city)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('branch.city.update-status', ['id' => $city->id]) }}"
                                                    class="btn {{ $city->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>


                                                <a href=" {{ route('branch.city.edit', $city->id) }}"
                                                ...
                                                onclick="event.preventDefault(); document.getElementById('cityForm{{ $city->id }}').submit();">
                                                <i class="fas fa-trash-alt"></i>
                                            </a>

                                            <form method="POST"
                                                action="{{ route('branch.city.destroy', ['id' => $city->id]) }}"
                                                id="cityForm{{ $city->id }}">
                                                @csrf
                                            </form>
