                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.add.service') }}" class=" float-right btn btn-primary">Add
                                        Service</a>
                                ...
                                <tbody>
                                    @foreach ($services as $service)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('frontend/service/' . $service->image) }}" width="100px"
                                                    alt="Slide Image">
                                            </td>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('branch.service.update-status', ['id' => $service->id]) }}"
                                                    class="btn {{ $service->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>


                                                <a href=" {{ route('branch.service.edit', $service->id) }}"
                                            ...
                                            <form method="POST"
                                                action="{{ route('branch.service.destroy', ['id' => $service->id]) }}"
                                                id="serviceForm{{ $service->id }}">
                                                @csrf
                                            </form>
