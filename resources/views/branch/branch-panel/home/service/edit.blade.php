                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.service.index') }}" class=" float-right btn btn-primary">Service</a>
                                </h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('branch.service.update', ['id' => $service->id]) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="number" name="description" class="form-control" id="description"> {{ $service->description }}  </textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <textarea class="form-control summernote" name="course_detail" id="horizontal-firstname-input199"> {{ $service->service_detail }}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="meta_keyword"  value="{{ $service->meta_keyword }}"   class="form-control"
                                                        id="meta_keyword">
