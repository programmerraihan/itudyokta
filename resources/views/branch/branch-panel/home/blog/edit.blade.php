                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.blog.index') }}" class=" float-right btn btn-primary">Edit
                                        Blog </a>
                                </h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('branch.blog.update', ['id' => $blog->id]) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="body">sort <span class="text-danger ">*</span>
                                                    </label>
                                                    <textarea type="text" name="sort" class="form-control" id="body"> {{ $blog->sort }} </textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="body">Body <span class="text-danger">*</span>
                                                    </label>

                                                    <textarea type="text" name="body" class="form-control summernote" id="description"> {{ $blog->body }}  </textarea>
                                        ...
                                        {{-- <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="long_text">Long Test <span class="text-danger">*</span>
                                                    </label>

                                                    <textarea type="text" name="long_text" class="form-control" id="long_text"> {{ $blog->long_text }}  </textarea>
