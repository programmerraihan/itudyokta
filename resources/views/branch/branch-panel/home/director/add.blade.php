                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.director.index') }}"
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('branch.store.director') }}" method="POST"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="formrow-inputState" name="director_type"
                                                        ...
                                                        <option value="0">Our Board of Directors </option>
                                                        <option value="1">Our Regional Directors </option>
