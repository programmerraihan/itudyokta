            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Division</h4>
                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.add.division') }}" class=" float-right btn btn-primary">Add
                                        Division</a>
                                    ...
                                    @foreach ($divisions as $division)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('branch.division.update-status', ['id' => $division->id]) }}"
                                                    class="btn {{ $division->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>


                                                <a href=" {{ route('branch.division.edit', $division->id) }}"
                                                ...
                                                onclick="event.preventDefault(); document.getElementById('divisionForm{{ $division->id }}').submit();">
                                                <i class="fas fa-trash-alt"></i>
                                            </a>

                                            <form method="POST"
                                                action="{{ route('branch.division.destroy', ['id' => $division->id]) }}"
                                                id="divisionForm{{ $division->id }}">
                                                @csrf
                                            </form>
