                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.project.index') }}" class=" float-right btn btn-primary">Project</a>
                                </h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('branch.project.update', ['id' => $project->id]) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <textarea class="form-control summernote" name="project_detail" id="horizontal-firstname-input199"> {{ $project->project_detail }}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="meta_keyword"  value="{{ $project->meta_keyword }}"   class="form-control"
                                                        id="meta_keyword">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    id="meta_description"> {{ $project->meta_description }}  </textarea>
