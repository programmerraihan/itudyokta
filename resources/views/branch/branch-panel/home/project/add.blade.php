                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('branch.store.project') }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group mb-4">
                                                    <label for="project_detail">Project Detail <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <textarea class="form-control summernote" name="project_detail" id="project_detail"></textarea>
                                                </div>
                                            </div>
