                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.add.testimonial') }}" class=" float-right btn btn-primary">Add
                                        Testimonial</a>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title"> Testimonial info Goers Here</h4>
                            {{-- <h4>
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('branch.testimonial.update-status', ['id' => $testimonial->id]) }}"
                                                    class="btn {{ $testimonial->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>


                                                <a href=" {{ route('branch.testimonial.edit', $testimonial->id) }}"
                                                    class="btn btn-success btn-sm waves-effect">
                                                    <i class="fas fa-edit"></i>
                                                </a>

                                                <a href="" class="btn btn-danger btn-sm"
                                                    onclick="event.preventDefault(); document.getElementById('testimonialForm{{ $testimonial->id }}').submit();">
                                                    <i class="fas fa-trash-alt"></i>
                                                </a>

                                                <form method="POST"
                                                    action="{{ route('branch.testimonial.destroy', ['id' => $testimonial->id]) }}"
                                                    id="testimonialForm{{ $testimonial->id }}">
                                                    @csrf
                                                </form>
