...
@section('admin')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18"> Student IN Out View</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Layouts</a></li>
                                <li class="breadcrumb-item active"> Student IN Out View</li>
                            </ol>
                        </div>
            ...
            <form action="{{ route('branch.student_in_out.view') }}" method="POST" class="form-horizontal"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-12">
                            <fieldset>
                                <legend> Student IN Out View </legend>
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="next_due_date">Month <span class="text-danger">*</span>
                                                        </label>
                                                        <input type="month" value="<?php echo date('Y-m'); ?>" name="date"
