    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form action="{{ route('branch.assignment.update', ['id' => $assignment->id]) }}" method="POST">
                    @csrf
                                                        ...
                                                        <select id="formrow-inputState" name="session_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Session --
                                                                ...
                                                                @foreach ($sessions as $session)
                                                                    <option value="{{ $session->id }}" {{($session->id == $assignment->session_id) ? 'selected' : '' }}> {{ $session->name }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                                        ...
                                                        <select id="formrow-inputState" name="course_title_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Course --
                                                                ...
                                                                @foreach ($courseTitles as $courseTitle)
                                                                    <option value="{{ $courseTitle->id }}" {{($courseTitle->id == $assignment->course_title_id) ? 'selected' : '' }}> {{ $courseTitle->title }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                                        ...
                                                        <select id="formrow-inputState" name="branch_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Branch --
                                                                ...
                                                                @foreach ($branches as $branch)
                                                                    <option value="{{ $branch->id }}"  {{($branch->id == $assignment->branch_id) ? 'selected' : '' }}> {{ $branch->name }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                        ...
                                                        <select id="batch_id" name="batch_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Batch --
                                                                ...
                                                                @foreach ($batches as $batch)
                                                                    <option value="{{ $batch->id }}"  {{($batch->id == $assignment->batch_id) ? 'selected' : '' }}> {{ $batch->name }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                        ...
                                                        <select id="formrow-inputState" name="schedule_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Schedule --
                                                                ...
                                                                @foreach ($schedules as $schedule)
                                                                    <option value="{{ $schedule->id }}" {{($schedule->id == $assignment->schedule_id) ? 'selected' : '' }}> {{ $schedule->name }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                        ...
                                                        <select id="teacher_id" name="teacher_id" class="form-control">
                                                            <option value="" disabled selected>-- Select Teacher --
                                                                ...
                                                                @foreach ($teachers as $teacher)
                                                                    <option value="{{ $teacher->id }}" {{($teacher->id == $assignment->teacher_id) ? 'selected' : '' }}>> {{ $teacher->name }}
                                                                    </option>
                                                                @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="sample_copy" placeholder="Sample Copy"
                                                            ...
                                                            <img src="{{ asset('admin/image/assignment/' . $assignment->sample_copy) }}"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="submission_deadline"   value="{{ $assignment->submission_deadline }}"  placeholder="Submission Deadline"
                                                            class="form-control">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="submission_end_deadline"  value="{{ $assignment->submission_end_deadline}}"  placeholder="Submission  End Deadline"
                                                            class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        class="form-control"> {{$assignment->description}}  </textarea>
