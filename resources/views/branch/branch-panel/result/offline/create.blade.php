...
@section('admin')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{ route('offline-exam.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-row">
                                            <div class="form-group col-md-4 col-sm-12">
                                                ...
                                                <input type="number" min="0" step="any" name="total_"
                                                    placeholder="Total" class="form-control" required />
                                            </div>
                                            <div class="form-group col-md-4 col-sm-12">
                                                <label for="gpa">CGPA*</label>
                                                <input type="number" min="0" step="any" name="cgpa"
                                                    placeholder="CGPA" class="form-control" required />
                                            </div>
                                            <div class="form-group col-md-4 col-sm-12">
                                                <label for="grade">Grade*</label>
                                                <input type="text" name="grade_" placeholder="Grade*"
