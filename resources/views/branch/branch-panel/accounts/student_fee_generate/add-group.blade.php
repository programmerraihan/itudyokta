...
@section('css')
    <style type="text/css">
        ...
        <link href=" {{ asset('css/summernote/css/summernote.css') }}" rel="stylesheet"/><link type="text/css" href="{{ asset('css/app.css') }}" rel="stylesheet"/><link rel="stylesheet" type="text/css" href="{{ asset('vendors/datatables/css/dataTables.bootstrap4.css') }}"/><link rel="stylesheet" type="text/css" href="{{ asset('css/custom.css') }}"><link rel="stylesheet" type="text/css" href="{{ asset('css/custom_css/datatables_custom.css') }}">
    </style>
@endsection
...
@section('script')
    <script>
        ...
        src = "{{ asset('vendors/datatables/js/jquery.dataTables.js') }}" >
    </script>
