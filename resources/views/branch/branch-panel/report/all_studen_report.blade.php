        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18"> Student Ledger</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('branch.due.student.list') }}" method="POST" enctype="multipart/form-data">
                        @csrf


                        <div class="col-lg-12">
                            <fieldset>
                                <legend> Student Ledger From </legend>
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body ">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#student_id').on('change', function() {
                ...
                // console.log(id);
                $.ajax({
                    url: '{{ route('collection.student.report.get') }}?student_id=' + id,
                    type: 'get',
                    success: function(res) {
                        $('#ladger').html(res);
                    }
