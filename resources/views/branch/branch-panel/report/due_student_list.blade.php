            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18"> Due Amount Student </h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Layouts</a></li>
                                <li class="breadcrumb-item active">Due Amount</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Due Amount Student </h4>
                            {{-- <h4>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($students as $student)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $student->student->name ?? 'Student Not Found'}}</td>
                                            <td>{{ $student->student->mobile ?? 'Student Not Found' }}</td>
                                            <td>{{ $student->student->email ?? 'Student Not Found' }}</td>
                                            <td>{{ $student->amount  ?? 'Amount Not Found'}}</td>
                                            <td>{{ $student->paid ?? 'Amount Not Found'}}</td>
                                            <td>{{ $student->due ?? 'Amount Not Found'}}</td>
