                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.add.studentUnit') }}"
                                        class=" float-right btn btn-primary">Student Unit
                                    </a>
                                    ...
                                    @foreach ($units as $unit)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('branch.studentUnit.update-status', ['id' => $unit->id]) }}"
                                                    class="btn {{ $unit->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>


                                                <a href=" {{ route('branch.studentUnit.edit', $unit->id) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('branch.studentUnit.destroy', ['id' => $unit->id]) }}"
                                                    id="unitForm{{ $unit->id }}">
                                                    @csrf
                                                </form>
