                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.batch.index') }}"
                                        class=" float-right btn btn-primary">Batch</a>
                                </h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('branch.store.batch') }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="" name="course_title_id" class="form-control">
                                                        ...
                                                        @foreach ($courses as $cours)
                                                            <option value="{{ $cours->id }}"> {{ $cours->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
