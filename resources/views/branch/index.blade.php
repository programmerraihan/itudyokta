        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                @php
                    ...
                    $expense_amount_total = App\Models\Expense::where('status', 1)
                        ->where('branch_id', $branch_id)
                        ->sum('expense_amount');
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-primary p-4">
                                        ...
                                        <h4 class="mb-0" style="color: #ffffff!important;"> Tk. {{ $expense_amount_m }}
                                        </h4>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-primary p-4">
                                        ...
                                        <h4 class="mb-0" style="color: #ffffff!important;"> Tk. {{ $expense_amount_y }}
                                        </h4>
                                    </div>
                                </div>
                ...
                @php
                    ...
                    $purchase_total = App\Models\PurchaseItem::where('branch_id', $branch_id)->sum('total_price');
                @endphp
                ...
                @php
                    ...
                    $income_total = App\Models\StudentFeeCollections::where('branch_id', $branch_id)->sum('paid');
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-primary p-4">
                                        ...
                                        <h4 class="mb-0" style="color: #ffffff!important;"> Tk. {{ $income_year }}
                                        </h4>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-primary p-4">
                                        ...
                                        <h4 class="mb-0" style="color: #ffffff!important;"> Tk.
                                            {{ $income_year - $purchase_year - $expense_amount_y }}
                                        </h4>
                                    </div>
                                </div>
