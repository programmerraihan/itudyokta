<head>
    ...
    <link rel="shortcut icon" type="text/css" href="{{ asset('frontend/assets/image/coxlogo.jpg') }}">
    <meta name="title" content="IT UDYOKTA." />
    <meta name="description" content="" />
    <meta name="keywords"
        content="IT UDYOKTA, Youth Development Computer Training Centre, Computer Training, YDCT, Chittagong, Raozan, Best Computer Training Centre, Office Application Program, Graphics Design, Hardware and Software, Diploma in Computer Science, Mohammad Morshed Alam, Korshed alam Ashek," />
