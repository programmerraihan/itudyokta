<section class="footer">
    <video class="videoBack" src="{{ asset('frontend/assets/video/4.mp4') }} " autoplay loop playsinline muted></video>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <p>
                        <span style="color:#ffd900;font-size:18px;font-weight:bold; margin-right:15px;"><i
                                class="fas fa-map-marker-alt"></i></span>{{ @$system->address2 }}<br>
                        <span style="color:#ffd900; font-size: 18px; font-weight: bold;margin-right: 15px;"><i
                                class="fas fa-phone"></i></span>{{ @$system->phone1 }}<br>
                        <span style="color:#ffd900; font-size: 18px; font-weight: bold;margin-right: 15px;"><i
                                class="far fa-envelope"></i></span><a href="https://mail.google.com/mail"
                            style="text-decoration:none;">{{ @$system->gmail2 }}</a>
                    </p>
                </div>
