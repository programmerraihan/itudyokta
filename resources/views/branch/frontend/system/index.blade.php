                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('branch.add.system') }}" class=" float-right btn btn-primary">
                                    ...
                                    @foreach ($systems as $system)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('branch.system.update-status', ['id' => $system->id]) }}"
                                                    class="btn {{ $system->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>


                                                <a href=" {{ route('branch.system.edit', $system->id) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('branch.system.destroy', ['id' => $system->id]) }}"
