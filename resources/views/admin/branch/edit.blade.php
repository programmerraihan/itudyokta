                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$branch->personal_name}}" name="personal_name"   placeholder="Name" class="form-control" id="name">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  value="{{$branch->father_name}}" name="father_name"  placeholder=" Father's Name" class="form-control"
                                                        id="father_name">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="mother_name" value="{{$branch->mother_name}}"  placeholder=" Mother's Name" class="form-control"
                                                        id="mother_name">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="mobil" value="{{$branch->mobil}}"  placeholder=" Mobil Number"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="personal_email" name="personal_email" value="{{$branch->personal_email}}" 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="formrow-inputState" name="gender" class="form-control">
                                                        ...
                                                        <option value="Female"  {{($branch->gender == "Female") ? 'selected' : '' }}>Female</option>
                                                        <option value="Other" {{($branch->gender == "Other") ? 'selected' : '' }} >Other</option>
                                                    </select>
                                                    @error('gender')
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="formrow-inputState" name="religion" class="form-control">
                                                        ...
                                                        <option value="Islam"  {{($branch->religion == "Islam") ? 'selected' : '' }} >Islam</option>
                                                        <option value="Sanatan"  {{($branch->religion == "Sanatan") ? 'selected' : '' }}  >Sanatan</option>
                                                        <option value="Buddhism"  {{($branch->religion == "Buddhism") ? 'selected' : '' }}  >Buddhism</option>
                                                        <option value="Christian"  {{($branch->religion == "Christian") ? 'selected' : '' }} >Christian</option>
                                                        <option value="Other"  {{($branch->religion == "Other") ? 'selected' : '' }} >Other</option>
                                                    </select>
                                                    @error('gender')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nationality"  value="{{$branch->nationality}}" placeholder="Nationality"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="division_id" name="division_id" class="form-control">
                                                        ...
                                                        @foreach ($divisions as $division)
                                                            <option value="{{ $division->id }}" {{($division->id == $branch->division_id) ? 'selected' : '' }}> {{ $division->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="district_id" name="district_id" class="form-control">
                                                        ...
                                                        @foreach ($districts as $district)
                                                            <option value="{{ $district->id }}" {{($district->id == $branch->district_id) ? 'selected' : '' }}> {{ $district->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="city_id" name="city_id" class="form-control">
                                                        ...
                                                        @foreach ($citys as $city)
                                                            <option value="{{ $city->id }}" {{($city->id == $branch->city_id) ? 'selected' : '' }}> {{ $city->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="upazila" value="{{$branch->upazila}}"  placeholder="Upazila"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="post_office" value="{{$branch->post_office}}"
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="institute_name"  value="{{$branch->institute_name}}"     placeholder="Institute Name " class="form-control" id="institute_name">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="institute_name_bangla" value="{{$branch->institute_name_bangla}}"   placeholder="Institute Name Bangla" class="form-control"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="institute_mobil" value="{{$branch->institute_mobil}}"  placeholder="Institute Mobil Number"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="institute_email" value="{{$branch->institute_email}}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="institute_facebook" value="{{$branch->institute_facebook}}"  placeholder="Institute Facebook Link" class="form-control"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="account_type" name="account_type"  class="form-control">
                                                        ...
                                                        <option value="personal_institute"  {{($branch->account_type == "personal_institute") ? 'selected' : '' }} >Personal Institute </option>
                                                        <option value="joind_venture_institute "  {{($branch->account_type == "joind_venture_institute") ? 'selected' : '' }} >Joind Venture Institute </option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="number_institute" value="{{$branch->number_institute}}" placeholder="Number of Institute "
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="institute_age"  value="{{$branch->institute_age}}" placeholder="Institute Age "
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="institute_division_id" name="institute_division_id" class="form-control">
                                                        ...
                                                        @foreach ($divisions as $division)
                                                            <option value="{{ $division->id }}" {{($division->id == $branch->institute_division_id) ? 'selected' : '' }}>  {{ $division->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="institute_district_id" name="institute_district_id" class="form-control">
                                                        ...
                                                        @foreach ($districts as $district)
                                                            <option value="{{ $district->id }}" {{($district->id == $branch->institute_district_id) ? 'selected' : '' }}> {{ $district->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="institute_city_id" name="institute_city_id" class="form-control">
                                                        ...
                                                        @foreach ($citys as $city)
                                                            <option value="{{ $city->id }}" {{($city->id == $branch->institute_city_id) ? 'selected' : '' }}> {{ $city->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="institute_upazila" value="{{$branch->institute_upazila}}"  placeholder="Upazila"
                                                        class="form-control" id="upazila">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="institute_post_office" value="{{$branch->institute_post_office}}"
                                                        placeholder="Post Office" class="form-control"
                                                        id="post_office">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="institute_address" value="{{$branch->institute_address}}" placeholder="Address"
                                                        class="form-control" id="address" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-4 col-sm-12 form-group">
                                                ...
                                                <input type="text" name="code" id="code" value="{{ $branch->code }}" placeholder="Code" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" value="{{$branch->name}}" placeholder="Name"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="password"  value="{{$branch->password}}" placeholder="Password"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="password_confirmation" value="{{$branch->password_confirmation}}" placeholder="Password Confirmation"
                                    ...
                                    <div class="card-body ">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="nid" placeholder="NID"
                                                        ...
                                                        <img src="{{ asset('admin/center/nid/' . $branch->nid) }}"
                                                        width="100px" alt="nid">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="input_file">
                                                        <label for="signature">Website Banner <span
                                                                class="text-danger">*</span>
                                                        </label>
                                                    </div>
                                                    <input type="file" name="website_banner" placeholder="Website Banner"
                                                        class="form-control" id="website_banner">

                                                        
                                                        <img src="{{ asset('admin/center/website_banner/' . $branch->website_banner) }}"
                                                        width="100px" alt="website_banner">
                                                </div>
                                            </div>
