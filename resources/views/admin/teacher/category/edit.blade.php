                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('teacher.category.index') }}" class=" float-right btn btn-primary">Teacher Category</a>
                                </h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form method="POST" action="{{ route('teacher.category.update', ['id' => $category->id]) }}" enctype="multipart/form-data">
                                        @csrf
