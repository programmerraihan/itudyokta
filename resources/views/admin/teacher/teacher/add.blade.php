                                ...
                                <div class="card">
                                    <div class="card-body ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="birth_date" class="form-control" placeholder="Birth of Date">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="passport_expiry_date" placeholder=" Passport Expiry Date"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="marital_status"> Marital Status<span class="text-danger">*</span>
                                                        </label>
                                                        <select id="marital_statuse" name="marital_status" class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="father_name">Father Name <span class="text-danger">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="mother_name">Mother Name <span class="text-danger">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="spouse_name">Spouse Name <span class="text-danger">*</span>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" name="present_address" placeholder="Present Address "
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" name="permanent_address" placeholder="Permanent Address"
                                                            class="form-control" > </textarea>
                                                    </div>
                                                </div>
                                            </div> 
                                ...
                                <div class="card">
                                    <div class="card-body ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="emergency_contact_name"> Emergency Contact Name <span class="text-danger">*</span>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="emergency_contact_no" placeholder="Emergency Mobil Number"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="emergency_relationship">Emergency Contact Relationship <span class="text-danger">*</span>
                                                        </label>
                                                        <input type="text" name="emergency_relationship" class="form-control" placeholder="Emergency Contact Relationship">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="emergency_address" placeholder="Emergency Contact Address"
                                                            class="form-control" > 
                                                    </div>
                                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="edu_qualification">Level of last education <span class="text-danger">*</span>
                                                        </label>
                                                        <input type="text" name="edu_qualification" class="form-control" placeholder="Level of last education">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="formrow-inputState">Teacher Category <span
                                                            class="text-danger">*</span> </label>
                                                                <select id="formrow-inputState" name="teacher_categories_id" class="form-control">
                                                                    <option value="" disabled selected>-- Select Teacher Category--
                                                                    </option>
