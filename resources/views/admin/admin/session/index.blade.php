                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    @can("session-add")
                                    <a href="{{ route('add.session') }}" class=" float-right btn btn-primary">Add
                                        session</a>
                                    @endcan
                                    ...
                                    @foreach ($sessions as $session)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                @can('session-approved')
                                                    <a href="{{ route('session.update-status', ['id' => $session->id]) }}"
                                                ...
                                                @can('session-delete')
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('session.destroy', ['id' => $session->id]) }}"
