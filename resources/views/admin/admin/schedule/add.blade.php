                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('session.index') }}" class=" float-right btn btn-primary">session</a>
                                </h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="formrow-inputState" name="courseTitle_id" class="form-control" data-placeholder="Course Name">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="batch_id" name="batch_id" class="form-control" data-placeholder="Batch Name">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    {{-- <select class="select2 form-control select2-multiple"  id="day[]" multiple="multiple" name="day[]">
