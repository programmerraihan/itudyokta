        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('assignment.update', ['id' => $assignment->id]) }}" method="POST">
                        @csrf
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title"
                                                            value="{{ $assignment->title }}" placeholder="Title"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                        ...
                                                        <select id="formrow-inputState" name="session_id"
                                                            ...
                                                            @foreach ($sessions as $session)
                                                                <option value="{{ $session->id }}"
                                                                    {{ $session->id == $assignment->session_id ? 'selected' : '' }}>
                                                                    {{ $session->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="formrow-inputState" name="course_title_id"
                                                            class="form-control">
                                                            ...
                                                            @foreach ($courseTitles as $courseTitle)
                                                                <option value="{{ $courseTitle->id }}"
                                                                    {{ $courseTitle->id == $assignment->course_title_id ? 'selected' : '' }}>
                                                                    {{ $courseTitle->title }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <select id="formrow-inputState" name="branch_id"
                                                            ...
                                                            @foreach ($branches as $branch)
                                                                <option value="{{ $branch->id }}"
                                                                    {{ $branch->id == $assignment->branch_id ? 'selected' : '' }}>
                                                                    {{ $branch->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <select id="batch_id" name="batch_id" class="form-control">
                                                            ...
                                                            @foreach ($batches as $batch)
                                                                <option value="{{ $batch->id }}"
                                                                    {{ $batch->id == $assignment->batch_id ? 'selected' : '' }}>
                                                                    {{ $batch->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="formrow-inputState" name="schedule_id"
                                                            class="form-control">
                                                            ...
                                                            @foreach ($schedules as $schedule)
                                                                <option value="{{ $schedule->id }}"
                                                                    {{ $schedule->id == $assignment->schedule_id ? 'selected' : '' }}>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="submission_deadline"
                                                            value="{{ $assignment->submission_deadline }}"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="submission_end_deadline"
                                                            value="{{ $assignment->submission_end_deadline }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" name="description" placeholder="Description" class="form-control"> {{ $assignment->description }}  </textarea>
