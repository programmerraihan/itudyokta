                                                        ...
                                                        <select id="formrow-inputState" name="session_id"
                                                            ...
                                                            @foreach ($sessions as $session)
                                                                <option value="{{ $session->id }}"
                                                                    {{ $session->id == $homework->session_id ? 'selected' : '' }}>
                                                                    {{ $session->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <select id="formrow-inputState" name="course_title_id"
                                                            ...
                                                            @foreach ($courseTitles as $courseTitle)
                                                                <option value="{{ $courseTitle->id }}"
                                                                    {{ $courseTitle->id == $homework->course_title_id ? 'selected' : '' }}>
                                                                    {{ $courseTitle->title }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <select id="formrow-inputState" name="branch_id"
                                                            ...
                                                            @foreach ($branches as $branch)
                                                                <option value="{{ $branch->id }}"
                                                                    {{ $branch->id == $homework->branch_id ? 'selected' : '' }}>
                                                                    {{ $branch->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <select id="batch_id" name="batch_id" class="form-control">
                                                            ...
                                                            @foreach ($batches as $batch)
                                                                <option value="{{ $batch->id }}"
                                                                    {{ $batch->id == $homework->batch_id ? 'selected' : '' }}>
                                                                    {{ $batch->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <select id="formrow-inputState" name="schedule_id"
                                                            ...
                                                            @foreach ($schedules as $schedule)
                                                                <option value="{{ $schedule->id }}"
                                                                    {{ $schedule->id == $homework->schedule_id ? 'selected' : '' }}>
                                                        ...
                                                        <select id="teacher_id" name="teacher_id" class="form-control">
                                                            ...
                                                            @foreach ($teachers as $teacher)
                                                                <option value="{{ $teacher->id }}"
                                                                    {{ $teacher->id == $homework->teacher_id ? 'selected' : '' }}>
                                                                    > {{ $teacher->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="submission_deadline"
                                                            value="{{ $homework->submission_deadline }}"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="submission_end_deadline"
                                                            value="{{ $homework->submission_end_deadline }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" name="description" placeholder="Description" class="form-control"> {{ $homework->description }}  </textarea>
