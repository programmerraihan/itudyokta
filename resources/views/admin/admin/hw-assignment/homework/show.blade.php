                            ...
                            <tbody>
                                @foreach ($homeworks as $homework)
                                    <tr>
                                        ...
                                        <td>{{ $homework->submission_deadline }}</td>
                                        <td>{{ $homework->submission_end_deadline }}</td>
