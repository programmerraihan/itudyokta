                ...
                <div class="main-div">
                        ...
                        <div class="main-content1">
                            ...
                            <div>
                                <table class="tg">
                                    ...
                                    @foreach ($feeCollect as $fee)
                                        <tr>
                                            <td class="tg-yw42 border-left">{{ $fee->fee->ac_head->name }}</td>
                                            <td class="tg-yw43">{{ $fee->paid }}</td>
                                        </tr>
                                    @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <td class="tg-yw43"><b>Tk. {{ $total }}</b></td>
                                    </tr>
                                </table>
                            </div>
                            <br><br><br>
                    ...
                    {{-- <div class='inner-div border-seperate'>
                        ...
                        <table style="margin-left: 20px;">
                            <tr>
                                <td>Memo No </td>
                                <td>: {{ $feeCollect->memo }}</td>
                            </tr>
                            <tr>
                                <td>Date </td>
                                <td>: {{ $feeCollect->date }}</td>
                            </tr>
                            <tr>
                                <td>Name </td>
                                <td>: {{ $student->name }}</td>
