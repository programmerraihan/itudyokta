    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Edit Account Head</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Layouts</a></li>
                                <li class="breadcrumb-item active">Edit Account Head</li>
                            </ol>
                        </div>
                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                {{-- <h4>
                                    <a href="{{ route('session.index') }}" class=" float-right btn btn-primary">Edit Account
                                        Head</a>
                                </h4> --}}
            ...
            <div class="row">
                <div class="col-lg-12">
                    <fieldset>
                        <legend> Edit Account Head</legend>
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">

                                    <form action="{{ route('account.head.type.update', ['id' => $accountHeadType->id]) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $accountHeadType->name }}"
