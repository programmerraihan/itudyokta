    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Edit Account Head Category</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Layouts</a></li>
                                <li class="breadcrumb-item active">Edit Account Head Category </li>
                            </ol>
                        </div>
                            ...
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('account.category.index') }}"
                                        class=" float-right btn btn-primary">Account
                                        Head Category</a>
                                </h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <fieldset>
                        <legend> Edit Account Head Category</legend>
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">

                                    <form
                                        action="{{ route('account.category.update', ['id' => $accountHeadCategory->id]) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name"
                                                        value="{{ $accountHeadCategory->name }}" class="form-control"
                                                    ...
                                                    <select id="account_head_type_id" name="account_head_type_id"
                                                        ...
                                                        @foreach ($accountHeadTypes as $accountHeadType)
                                                            <option value="{{ $accountHeadType->id }}"
                                                                {{ $accountHeadType->id == $accountHeadCategory->account_head_type_id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="details" class="form-control" value="" placeholder="Details" id="name"> {{ $accountHeadCategory->details }}</textarea>
