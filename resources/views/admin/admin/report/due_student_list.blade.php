                                ...
                                <tbody>
                                    ...
                                    @foreach ($students as $student)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $student->student->name  ?? 'None'}}</td>
                                            <td>{{ $student->student->mobile  ?? 'None'}}</td>
                                            <td>{{ $student->student->email  ?? 'None'}}</td>
                                            <td>{{ $student->amount ?? 'None'}}</td>
                                            <td>{{ $student->paid ?? 'None'}}</td>
                                            <td>{{ $student->due ?? 'None'}}</td>
