...
@section('admin')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18"> Student Result</h4>
            ...
            <form action="{{ route('student_result.view') }}" method="POST" class="form-horizontal"
                                    ...
                                    <div class="card">
                                        <div class="card-body ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="next_due_date">MCQ Total Mark <span
                                                                class="text-danger">*</span>
                                                        </label>
                                                        <input type="number" name="mcq_mark" id="mcq_mark"
                                                            class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="next_due_date">Assessment Total Mark <span
                                                                class="text-danger">*</span>
                                                        </label>
                                                        <input type="number" name="assessment_mark" id="assessment_mark"
                                                            class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="next_due_date">Viva Total Marks <span
                                                                class="text-danger">*</span>
                                                        </label>
                                                        <input type="number" name="viva_mark" id="viva_mark"
                                                            class="form-control">
