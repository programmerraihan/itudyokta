                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="initial_name"
                                                                value="{{ $employee->initial_name }}" class="form-control"
                                                                id="initial_name">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="department"
                                                                value="{{ $employee->department }}" class="form-control"
                                                                id="department">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="formrow-Web-input">Phon Number <span
                                                                    class="text-danger">*</span> </label>
                                                            <input type="number" name="phon_number"
                                                                value="{{ $employee->phon_number }}" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="room_no"
                                                                value="{{ $employee->room_no }}" class="form-control"
                                                                id="address">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <img src="{{ asset($employee->profile_image) }}" alt=""
