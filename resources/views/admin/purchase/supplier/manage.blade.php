                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('supplier.store') }}" method="POST">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label for="horizontal-firstname-input" class="col-sm-2 col-form-label"> Supplier
                                            Name</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="name" class="form-control"
                                                id="horizontal-firstname-input" placeholder="Supplier Name" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row justify-content-end">
                                        <div class="col-sm-10">
                                            ...
                                            <div>
                                                <button type="submit" class="btn btn-primary w-md">Create New Supplier
                                                </button>
                                            </div>
                                        </div>
                                    </div>
