...
@section('admin')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18"> Student Mark Sheet Card </h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Layouts</a></li>
                                <li class="breadcrumb-item active"> Student Mark Sheet Card </li>
                            </ol>
                        </div>
            ...
            <form action="{{ route('markSheet.card.generate') }}" method="POST" class="form-horizontal"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-12">
                            <fieldset>
                                <legend> Student Mark Sheet Card </legend>
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body ">
