                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('about.index') }}" class=" float-right btn btn-primary">About</a>
                                </h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="long_text" class="form-control" id="long_text"> {{ $about->long_text }}  </textarea>
