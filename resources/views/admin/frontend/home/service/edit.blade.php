                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <textarea class="form-control summernote" name="service_detail" id="horizontal-firstname-input199"> {{ $service->service_detail }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="meta_keyword"
                                                        value="{{ $service->meta_keyword }}" class="form-control"
                                                        id="meta_keyword">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="meta_description" class="form-control" id="meta_description"> {{ $service->meta_description }}  </textarea>
                                                </div>
                                            </div>
                                        </div>
