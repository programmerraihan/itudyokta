                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Add System Setting</li>
                            </ol>
                        </div>
                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                <h4>
                                    <a href="#" class=" float-right btn btn-primary"> System
                                        Setting</a>
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('store.system') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="gmail1" class="form-control"
                                                        id="gmail1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="facebook_embed" class="form-control" id="facebook_embed"></textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="google_embed" class="form-control" id="google_embed"></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="start_day_time" class="form-control"
                                                        id="start_day_time">
