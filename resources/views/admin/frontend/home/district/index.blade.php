                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('add.district') }}" class=" float-right btn btn-primary">Add
                                        District</a>
                                    ...
                                    @foreach ($districts as $district)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('district.update-status', ['id' => $district->id]) }}"
                                            ...
                                            <form method="POST"
                                                action="{{ route('district.destroy', ['id' => $district->id]) }}"
