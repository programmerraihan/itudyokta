                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('add.division') }}" class=" float-right btn btn-primary">Add
                                        Division</a>
                                    ...
                                    @foreach ($divisions as $division)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('division.update-status', ['id' => $division->id]) }}"
                                            ...
                                            <form method="POST"
                                                action="{{ route('division.destroy', ['id' => $division->id]) }}"
