                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="commission" value="{{ $course->commission }}" class="form-control" id="commission"  required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="offer_price" value="{{ $course->offer_price }}" class="form-control"
                                                        id="offer_price">
                                                </div>
                                            </div>
