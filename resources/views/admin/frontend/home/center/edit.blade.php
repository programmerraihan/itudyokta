            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Edit Center</h4>
                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                <h4>
                                    <a href="{{ route('center.index') }}" class=" float-right btn btn-primary">Center</a>
                                </h4>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body ">
                                    ...
                                    <form action="{{ route('center.update', ['id' => $center->id]) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $center->title }}" name="title"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="image" class="form-control"
                                                        id="image">
                                                    <img src="{{ asset('frontend/center/' . $center->image) }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="description" class="form-control" id="description"> {{ $center->description }}  </textarea>
                                                </div>
                                            </div>
