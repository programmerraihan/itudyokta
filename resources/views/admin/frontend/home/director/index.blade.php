                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('add.director') }}" class=" float-right btn btn-primary">Add
                                        Director</a>
                                    ...
                                    @foreach ($directors as $director)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('director.update-status', ['id' => $director->id]) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('director.destroy', ['id' => $director->id]) }}"
