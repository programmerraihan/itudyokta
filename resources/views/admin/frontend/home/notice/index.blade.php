                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('add.notice') }}" class=" float-right btn btn-primary">Add
                                        Notice</a>
                                ...
                                <tbody>
                                    @foreach ($notices as $notice)
                                        <tr>
                                            ...
                                            <td>{{ Str::limit($notice->title, 25) }}</td>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('notice.update-status', ['id' => $notice->id]) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('notice.destroy', ['id' => $notice->id]) }}"
