                    ...
                    <div class="">
                        <div class="">
                            <div class="invoice-title">
                                ...
                                <h4>
                                    <a href="{{ route('add.testimonial') }}" class=" float-right btn btn-primary">Add
                                        Testimonial</a>
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('testimonial.update-status', ['id' => $testimonial->id]) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('testimonial.destroy', ['id' => $testimonial->id]) }}"
