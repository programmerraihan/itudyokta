...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Baloo+Thambi+2:wght@400;500;600&family=Nunito:wght@400;600;700&display=swap"
        rel="stylesheet">
    <style>
        * {
            font-family: 'Nunito';
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-6 offset-3">
                <h1 class="text-center">It Udyokta</h1>
                ...
                <form action="{{ route('uddoktapay.pay') }}" class="mt-4" method="POST">
                    ...
                    <input name="full_name" type="text" id="name" class="form-control mt-2" value="Name">

                    <label for="email" class="mt-4"><b>Email:</b></label>
                    <input name="email" type="email" id="email" class="form-control mt-2"
