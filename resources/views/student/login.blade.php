...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login | Login | Student login IT UDYOKTA</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="p-2">
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('student.login') }}">
                                    ...
                                    <div class="mt-4 text-center">
                                        <a href="{{ route('password.request', ['type' => 'student']) }}" class="text-muted"><i
                    ...
                    <div class="mt-5 text-center">
                        <div>
                            <p>Don't have an account ? <a href="{{ route('student.register') }}"
