                          ...
                          <div class="col-lg-12">
                              <div class="card">
                                  <div class="card-body ">
                                      ...
                                      <form action="{{ route('submitted.assignment.store') }}" method="POST"
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-12">
                                                  <div class="form-group">
                                                      <label for="assignment_file">Assignment File Word/pdf/ <span class="text-danger">*</span>
                                                      </label>
                                          ...
                                          <div class="row">
                                              <div class="col-lg-12">
                                                  ...
                                                  <div class="form-group mb-4">
                                                      <label for="assignment_detail">Assignment Write / Other Option <span
