                                    ...
                                    @foreach ($assignments as $assignment)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href=" {{ route('submitted.assignment.edit', $assignment->id) }}"
                                                ...
                                                <a href="{{ asset('frontend/service/' . $assignment->sample_copy) }}"
                                                    class="btn btn-success btn-sm waves-effect" download>
