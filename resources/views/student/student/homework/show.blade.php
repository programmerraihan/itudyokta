                      ...
                      <div class="">
                          <div class="">
                              <div class="invoice-title">
                                  ...
                                  <h4>
                                      <a href="{{ route('submitted.homework.manage') }}" class=" float-right btn btn-primary">Home Work</a>
                                  </h4> 
                                ...
                                <tbody>
                                    @foreach ($homeworks as $homework)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('frontend/service/' . $homework->file) }}" width="100px"
                                                    alt="Slide Image">
                                            </td>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href=" {{ route('submitted.homework.edit', ['id' => $homework->id]) }}"
                                                    class="btn btn-primary btn-sm waves-effect">
                                                    <i class="fas fa-edit"> Submitted</i>
                                                    
                                                </a>
                                                {{-- <a href="{{ route('submitted.homework.update-status', ['id' => $homework->id]) }}"
                                                    class="btn {{ $homework->status == 1 ? 'btn-info' : 'btn-warning' }} btn-sm">
                                                    <i class="fas fa-arrow-alt-circle-up"></i>
                                                </a>  --}}

                                                <a href="{{ asset('admin/image/homework/' . $homework->sample_copy) }}"
                                                    class="btn btn-success btn-sm waves-effect" > 
                                                    <i class="fa fa-download" aria-hidden="true"></i>
                                                </a>


                                                {{-- <a href=" {{ route('submitted.homework.edit', $homework->id) }}"
                                                    class="btn btn-success btn-sm waves-effect">
                                                ...
                                                {{-- <a href="" class="btn btn-danger btn-sm"
                                                onclick="event.preventDefault(); document.getElementById('homeworkForm{{ $homework->id }}').submit();">
                                                <i class="fas fa-trash-alt"></i> --}}
                                            </a>

                                            {{-- <form method="POST"
                                                action="{{ route('submitted.homework.delete', ['id' => $homework->id]) }}"
                                                id="homeworkForm{{ $homework->id }}">
                                                @csrf
                                            </form> --}}
