                            ...
                            <form action="{{ route("assets.store") }}" method="post">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label>Date*</label>
                                        <input type="date" name="date" class="form-control @error('date') is-invalid @endif" required />
                                        @error('date')
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @endif" placeholder="Asset Name*" required />
                                        @error('name')
                                            <div class="invalid-feedback">{{$message}}</div>
                                        @enderror
                                    </div>                                   
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="supplier_name" class="form-control @error('supplier_name') is-invalid @endif" placeholder="Supplier Name*" required />
                                        @error('supplier_name')
                                            <div class="invalid-feedback">{{$message}}</div>
                                        @enderror
                                    </div>                                    
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <input type="number" min="0" step="any" name="purchase_price" class="form-control @error('purchase_price') is-invalid @endif" placeholder="Purchase Price*" required />
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <input type="number" min="0" readonly step="any" name="total_purchase_price" class="form-control @error('total_purchase_price') is-invalid @endif" placeholder="Toltal Purchase Price*" required />
