                            ...
                            <form action="{{route("sales.update", ["sale" => $sale->id])}}" method="post">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 col-sm-12 form-group">
                                        ...
                                        <input type="date" name="date" value="{{$sale->date}}" class="form-control @error("date") is-invalid @enderror " required/>
                                        @error('date')
                                    ...
                                    <div class="col-md-6 col-sm-12 form-group">
                                        ...
                                        <input type="text" name="reference_no" value="{{$sale->reference_no}}" class="form-control @error("reference_no") is-invalid @enderror " required/>
                                        @error('reference_no')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 col-sm-12 form-group">
                                        ...
                                        <input type="text" name="customer" value="{{$sale->customer}}" id="customer" placeholder="Customer" class="form-control @error("customer") is-invalid @enderror " required/>
                                        @error('customer')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 col-sm-12 form-group">
                                        ...
                                        <input type="tel" name="phone" value="{{$sale->phone}}" id="phone" placeholder="Phone" class="form-control @error("phone") is-invalid @enderror "/>
                                        @error('phone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <table class="table table-sm table-bordered" id="product_list">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td><button class="btn btn-xs btn-outline-danger delete_btn" type="button">Remove</button></td>
                                        </tr>
                                        @empty                                            
                                        @endforelse
                                    </tbody>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 col-sm-12 form-group">
                                        ...
                                        <input type="number" name="net_amount" id="net_amount" placeholder="Net Amount" value="{{$sale->grand_total}}" class="form-control @error("net_amount") is-invalid @enderror "/>
                                        @error('net_amount')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
